        ...
        <aside class="right_side">
            <div class="common-div">
                ...
                ${currentName=="კობა ლეთოდიანი" ? `
                    ...
                    <span class="read-more-content" id="showOrHideDiv">მარჯვენა თვალი წლების წინ აფხაზეთში დაუზიანდა - 1992 წლის 12 ოქტომბერს ვერტმფრენს, სადაც 5 მგზავრთან ერთად იჯდა ნაღმტყორცნის ჭურვი მოხვდა - ვერტმფენს “კუდი” მოწყდა და ჩამოვარდა.  კობამ რამდენიმე თვე ჰოსპიტალში გაატარა. სოხუმის დაცემმადე იბრძოდა. ვერასდროს  წარმოიდგენდა, რომ სერგეი გავრილოვი, რომელიც  ფულით, იარაღით,  და ინფორმაციით ებრძოდა საქართველოს ტერიტორიულ მთლიანობას,  27 წლის შემდეგ მის ქვეყანაში თავისუფლად შემოვიდოდა. “ომში შენც ისვრი, სხვაც გესვრის და ეს სხვა მტერია, ერთი წლის წინ პარლამენტთან კი მტრის მაგივრად სახელმწიფო “ებრძოდა” ხალხს”- , ამბობს კობა. 

                    50 წლის კობა  20 ივნისს სახლიდან  ორჯერ გავიდა, პირველად დღე, როცა რუსი კომუნისტი დეპუტატის პარლამენტში გამოჩენას სპონტანური პროტესტი მოჰყვა, მეორედ უკვე შებინდებულზე, მეგობართან ერთად ტელევიზორს უყურებდა და სპეცდანიშნულების რაზმები რომ დაინახა, მიხვდა, რომ   პარლამენტის წინ უნდა ყოფილიყო.   
                    ...
                    კობას მკურნალობას, ისევე როგორც 20 ივნისს სხვა დაშავებულებისას, ფონდი “ქართუ” ფარავს. სახელმწიფო მას დაზარალებულად არ ცნობს. საქართველოს 
